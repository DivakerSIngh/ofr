...
namespace OneFineRateBLL.Entities
{
    ...
    public class etblPropertyM : IValidatableObject
    {
        ...
        [DefaultValue("0")]
        public string sInitialHotelName { get; set; }
        [DisplayName("Chain")]
        ...
        //[RegularExpression(@"(http(s?)://)?(www\.)?[A-Za-z0-9-]+(\.[a-z]{2,3})?+(\.[a-z]{2,2})?", ErrorMessage = "Please Enter Valid URL. Ex: http://www.example.com")]
        ...
        [StringLength(15, ErrorMessage = "Only 15 characters allowed.")]
    ...
    public class ForValidation
    {
        ...
        public DateTime? ValidFromOld { get; set; }
        public DateTime? ValidToOld { get; set; }
    }
