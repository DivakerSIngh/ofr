...
{
    public class BL_tblPropertyLOSBiddingMap
    {
        //Update a record
        public static int AddUpdateRecord(etblPropertyLOSBiddingMap eobj, DataTable BidRange)
        {
            int retval = 0;
        ...
        public static PropertyBiddingMapForOverview GetRecords(DateTime EffectiveDate, int PropId, int typ, string corporateOrPublic)
        {
            ...
            using (OneFineRateEntities db = new OneFineRateEntities())
            {
                ...
                {
                    var eobj = (from c in db.tblPropertyLOSBiddingMaps
                ...
                {
                    var eobj = (from c in db.tblPropertyLOSBiddingMapCorps
