...
{
    public class BL_tblPropertyRoomsBiddingMap
    {
        //Update a record
        ...
        public static PropertyBiddingMapForOverview GetRecords(DateTime EffectiveDate, int PropId, int typ,string corporateOrPublic)
        {
            ...
            using (OneFineRateEntities db = new OneFineRateEntities())
            {
                ...
                {
                    var eobj = (from c in db.tblPropertyRoomsBiddingMaps
                ...
                {
                    var eobj = (from c in db.tblPropertyRoomsBiddingMapCorps
            ...
            if (corporateOrPublic == null && typ == 9)
            {
                OBJ.Self = eobjPublic;
                OBJ.Other = eobjCorp;
                OBJ.IsPublic = true;
            ...
            //{
            //    OBJ.Self = eobjPublic.ToList();
            //    OBJ.Other = eobjCorp.ToList();
            //    OBJ.IsPublic = true;
            //}
            //else
            //{
            //    OBJ.Self = eobjCorp.ToList();
            //    OBJ.Other = eobjPublic.ToList();
            //    OBJ.IsPublic = false;
            //}
            return OBJ;
