...
namespace OneFineRateWebBLL.NotMapped
{
        ...
        where TUser : WebsiteUserMaster
        {
            ...
            public Task<IList<UserLoginInfo>> GetLoginsAsync(TUser user)
            {
                ...
                // TO DO
                var userLoginAsyncList = (IList<UserLoginInfo>)(user.Logins.ToList());

                return Task.FromResult<IList<UserLoginInfo>>(userLoginAsyncList);
            }
            ...
            public Task AddClaimAsync(TUser user, Claim claim)
            {
                ...
                {
                    user.Claims.Add(new WebsiteUserClaim
                    {
            ...
            public Task<IList<string>> GetRolesAsync(TUser user)
            {
                ...
                // TO DO 
                var userRoleStringList= user.Roles as IList<string>;

                return Task.FromResult<IList<string>>(userRoleStringList);
            }
            ...
            public Task<bool> IsInRoleAsync(TUser user, string roleName)
            {
                if (user == null)
                    throw new ArgumentNullException("user");
                //expression : user.Roles.Contains(roleName, StringComparer.InvariantCultureIgnoreCase)
