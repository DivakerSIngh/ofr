...
namespace FutureSoft.Util
{
    ...
    public class MailComponent
    {
        ...
        public static void SendEmailOld(string sToEmail, string sCcEmail, string sBCcEmail, string sSubject, string sBody, Attachment objAttachment, AlternateView objAlternateView, bool bIsHtml)
        {
            SmtpClient objSmtpClient = null;
            MailMessage objMailMessage = null;
            int iPort = 0;
