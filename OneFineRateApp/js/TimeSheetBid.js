        ...
        var initRows = function () {
            for (var row = 0, curRowHtml = ''; row < sheetOption.data.dimensions[0]; ++row) {
                ...
                if (row == 6) {
                    ...
                    curRowHtml += '<td style="border-right: none;background-color: white;"></td>';
                    curRowHtml += '</tr>';
                ...
                if (row == 11) {
                    curRowHtml = '<tr class="TimeSheetBid-row">'
                    curRowHtml += '<td><input type="checkbox" class="hddesc" ctype=""  style="display:none " /><strong class="blue">UPGRADES</strong></td>';
                    curRowHtml += '</tr>';
                    thisSheet.append(curRowHtml);
                }
                ...
                for (var col = 0, curCell = ''; col <= sheetOption.data.dimensions[1]; ++col) {
                    if (col === 0) {
                        if (sheetOption.data.rowHead[row].type == 0) {
                            curCell = '<td title="' + (sheetOption.data.rowHead[row].title ? sheetOption.data.rowHead[row].title : "") + '"class="text-left TimeSheetBid-rowHead digonalline ' + (row === sheetOption.data.dimensions[0] - 1 ? 'bottomMost ' : ' ') + '" style="' + (sheetOption.data.rowHead[row].style ? sheetOption.data.rowHead[row].style : '') + '"><input type="checkbox" class="hddesc" ctype="' + sheetOption.data.rowHead[row].type + '"  style="margin-right: 7px; display:none " /><strong class="blue"><div style="float:right;">Bid Room </div> Discount</strong></td>';
                        }
                        else {
                            curCell = '<td title="' + (sheetOption.data.rowHead[row].title ? sheetOption.data.rowHead[row].title : "") + '"class="text-left TimeSheetBid-rowHead ' + (row === sheetOption.data.dimensions[0] - 1 ? 'bottomMost ' : ' ') + '" style="' + (sheetOption.data.rowHead[row].style ? sheetOption.data.rowHead[row].style : '') + '"><input type="checkbox" class="hddesc" ctype="' + sheetOption.data.rowHead[row].type + '"  style="margin-right: 7px;" /><strong class="blue">' + sheetOption.data.rowHead[row].name + '</strong></td>';
                        }
                    } else if (row == 0) {
