            ...
            function setText(n, ctype) {
                ...
                if (itype == 'children' + roomcount + '') {     //on click event of children
                    ...
                    if (ctype == 'Forward') {   //if adding no of chilrens
                        childhtml = '';
                        childhtml += ' <li id="childli' + i + '' + roomcount + '" class="childli"><input id="child' + i + '' + roomcount + '" itype="childage" class="form-control child showdata" readonly="readonly" type="number" value="<1" min="1" max="11" /> </li>';
...
function AddRooms_temp() {
    ...
    myval += "<div class='col-md-12  pull-left'><h5><strong>Room" + roomcount + ":</strong></h5></div>";
    myval += "<div class='col-md-6'>";
    ...
    myval += '</div></div>';
    myval += "<div class='col-md-12' id='temp_divChildAge" + roomcount + "' style='display:none;'>";
    ...
    if (data.length > 0) {
        ...
        $.each(data, function (key, value) {
            ...
            if (value.ChildAge.length > 0)
                myval += "<div class='col-md-12' id='temp_divChildAge" + roomcount + "'>";
            else
                myval += "<div class='col-md-12' id='temp_divChildAge" + roomcount + "' style='display:none;'>";
            myval += ' <h5><strong>Age of Childen</strong></h5>';
            ...
            $.each(value.ChildAge, function (key, val) {
                var desc = '<li id="childli' + i + '' + roomcount + '" class="childli"><input id="child' + i + '' + roomcount + '" itype="childage" class="form-control child showdata" readonly="readonly" type="number" value="' + val.Age + '" min="1" max="12" /> </li>';
