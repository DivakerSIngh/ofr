...
function DrawBookingOverviewChart(data) {
    ...
    try {
        ...
        if (data.TotalViews_Ours.Corporates > 0) {

            var item = {
                pName: 'Corporate',
                name: data.TotalViews_Ours.Corporates,
                y: data.TotalViews_Ours.Corporates,
                color: bidColor
            }
        ...
        if (data.TotalViews_Competitors.Corporates > 0) {

            var item = {
                pName: 'Corporate',
                name: data.TotalViews_Competitors.Corporates,
                y: data.TotalViews_Competitors.Corporates,
                color: bidColor
            }
    ...
    try {
        ...
        if (data.TotalBookings_Ours.Corporates > 0) {

            var item = {
                pName: 'Corporate',
                name: data.TotalBookings_Ours.Corporates,
                y: data.TotalBookings_Ours.Corporates,
                color: bidColor
            }
        ...
        if (data.TotalBookings_Competitors.Corporates > 0) {

            var item = {
                pName: 'Corporate',
                name: data.TotalBookings_Competitors.Corporates,
                y: data.TotalBookings_Competitors.Corporates,
                color: bidColor
            }
...
function DrawBookingInsightsChart(data) {
    ...
    if (!isOnlyOverall) {
        ...
        leadTimeSeriesData.push({
            ...
            name: 'My Property' + currentSelectedType,
