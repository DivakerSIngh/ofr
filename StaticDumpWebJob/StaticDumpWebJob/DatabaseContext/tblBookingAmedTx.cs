namespace StaticDumpWebJob.DatabaseContext
{
    ...
    [Table("tblBookingAmedTx")]
    public partial class tblBookingAmedTx
    {
        public tblBookingAmedTx()
        {
            tblBookingCancellationPolicyAmendMaps = new HashSet<tblBookingCancellationPolicyAmendMap>();
        ...
        public virtual ICollection<tblBookingCancellationPolicyAmendMap> tblBookingCancellationPolicyAmendMaps { get; set; }
