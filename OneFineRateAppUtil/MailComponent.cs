    ...
    public class MailComponent
    {
        ...
        public static void SendEmail(string sToEmail, string sCcEmail, string sBCcEmail, string sSubject, string sBody, Attachment objAttachment, AlternateView objAlternateView, bool bIsHtml, System.IO.Stream attchmentFileStream, string attchmentFileName)
        {
            ...
            if (iPort == 465)
            {
                ...
                {
                    string s = ex.Message;
                    SendEmailTest("deepaka@futuresoftindia.com,himanshuS@futuresoftindia.com", "", "", "Error", ex.ToString() + "Message:: " + ex.Message, null, null, true);
        ...
        //            client.Authenticate(FromMail, SmtpCredential);
        ...
        //                if (SmtpCredential != "")
        //                {
        //                    objSmtpClient.Credentials = new System.Net.NetworkCredential(FromMail, SmtpCredential);
        //                }
        //                else
        //                {
        //                    objSmtpClient.UseDefaultCredentials = true;
        ...
        public static void SendEmailTest(string sToEmail, string sCcEmail, string sBCcEmail, string sSubject, string sBody, Attachment objAttachment, AlternateView objAlternateView, bool bIsHtml)
        {
            SmtpClient objSmtpClient = null;
            MailMessage objMailMessage = null;
            int iPort = 0;
            try
            {
                //string SMTPClient = "s11.cyberspaceindia.com";
                //string SMTPPort = "465";
                //bool EnableSSL = true;
                //string FromMail = "no-reply@onefinerate.com";
                //string SmtpCredential = "Nr$zC2017#";

                //objSmtpClient = new SmtpClient(SMTPClient);
                //iPort = Convert.ToInt32(SMTPPort);

                string SMTPPort = ConfigurationManager.AppSettings["SMTPPort_Test"].ToString();
                string SMTPClient = ConfigurationManager.AppSettings["SMTPClient_Test"].ToString();
                bool EnableSSL = Convert.ToBoolean(ConfigurationManager.AppSettings["EnableSSL_Test"].ToString());
                string FromMail = ConfigurationManager.AppSettings["FromMail_Test"].ToString();
                string SmtpCredential = ConfigurationManager.AppSettings["SmtpCredential_Test"].ToString();
        ...
        public static void SendEmailWithMUltipleAttachments(string sToEmail, string sCcEmail, string sBCcEmail, string sSubject, string sBody, System.Net.Mail.MailMessage objMailMessage, AlternateView objAlternateView, bool bIsHtml)
        {
            SmtpClient objSmtpClient = null;
            int iPort = 0;
            try
